...
# hate-none classification

nonel = full_df[full_df['class']=='none']
hatel = full_df[full_df['class']=='offensive']
hatel = hatel.head(len(nonel))
off_none = pd.concat([nonel, hatel, full_df[full_df['class']=='hate']])
full_df['class'].replace(['offensive'],['hate'], inplace = True)
